...
const MyCart = ({ navigation }) => {
  ...
  useEffect(() => {
    const sum = cart.reduce(
      (total, item) =>
        Number(item.productPrice) * Number(item.qty) + Number(total),
      0
    );
    setTotal(sum);
  }, [cart]);
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <TouchableOpacity key={data.key} onPress={() => onRemove(data)}>
              ...
              >
                <TouchableOpacity key={data.key} onPress={() => onAdd(data)}>
                  <MaterialCommunityIcons
                    name="plus"
                    style={{
                      fontSize: 16,
            ...
            <TouchableOpacity key={data.key} onPress={() => removeItemFromCart(data)}>
              <MaterialCommunityIcons
                name="delete-outline"
                style={{
                  fontSize: 16,
